.PHONY: all
all : build/robot-git.pdf build/robot-embedded-TP1.pdf build/robot-embedded-TP1-adc-header.tar.gz build/robot-simu-TP1.pdf \
...
build/robot-embedded-TP1-adc-header.tar.gz: tp1/adc_cxx.hpp
	tar -cvzf $@ $^
